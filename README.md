...
一个围绕电子、硬件、超频实验与次元收藏展开的个人博客。首页采用档案工作台：分类、记录列表和当前档案预览在同一视图中协作，全文与收藏图集在独立地址阅读。界面参考 RhineLabUI 与《明日方舟》莱茵生命终端的排版和操作节奏，保留个人角色图及昼夜主题。

## 主要功能

- 白昼与夜间双主题，带有从切换按钮向全屏扩散的过渡动画
- 档案分类、列表和预览联动，分类间保留选中记录；支持方向键、Home / End 和 Enter 阅读
- 手机端横向档案条与纵向预览，文章主题筛选与全站搜索
